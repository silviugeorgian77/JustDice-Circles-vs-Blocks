...
public static class MathUtils
{
	...
	/// </summary>
	public static float VectorDotProduct(Vector2 vector1, Vector2 vector2)
	{
	...
	/// dotProduct = 1 => the vectors are pointing in exactly the same direction
	/// </summary>
	public static float VectorDotProduct(Vector3 vector1, Vector3 vector2)
	{
	...
	/// </summary>
	public static float VectorCrossProduct(Vector2 vector1, Vector2 vector2)
	{
	...
	public static float AngleBetweenTwoVectors(Vector2 vector1, Vector2 vector2)
	{
