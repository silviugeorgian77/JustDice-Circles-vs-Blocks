...
{
    public static Vector2 GetOrtographicSize(Camera camera)
    {
    ...
    public static Vector2 GetPerspectiveFrustumSize(Camera camera)
    {
    ...
    public static float GetOrtographicCameraAspectRatio(Camera camera)
    {
